...
public class Activie1MicroServiceApplication {

	public static void main(String[] args) {
		SpringApplication.run(Activie1MicroServiceApplication.class, args);
	}
  ...
  CommandLineRunner start(BankAccountRepository bankAccountRepository , CustomerRepository customerRepository){
    return args -> {
      Stream.of("Mohammed","Yassin","Assil","Narine").forEach(c->{
